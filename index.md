...
<p>Mouth<span>
  <input value="a dry cough" type="button" onClick="showTime([cold]);document.symptom.Influenza.value='Influenza'">
  ...
  <input value="coughing stomach acid" type="button" onClick="showTime([gastroesophagealRefluxDisease.value])">
...
<p>Nose<span>
  ...
  <input value="sneezing" type="button" onClick="showTime([cold]);document.symptom.Influenza.value='Influenza'">
